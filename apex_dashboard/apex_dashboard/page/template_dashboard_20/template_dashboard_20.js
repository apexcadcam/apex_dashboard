frappe.pages['template_dashboard_20'].on_page_load = function(wrapper) {
    new TemplateDashboard20(wrapper);
};

class TemplateDashboard20 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-20');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_20' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 20';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_20.template_dashboard_20.get_dashboard_data',

frappe.pages['template_dashboard_06'].on_page_load = function(wrapper) {
    new TemplateDashboard06(wrapper);
};

class TemplateDashboard06 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-06');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_06' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 06';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_06.template_dashboard_06.get_dashboard_data',

frappe.pages['template_dashboard_12'].on_page_load = function(wrapper) {
    new TemplateDashboard12(wrapper);
};

class TemplateDashboard12 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-12');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_12' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 12';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_12.template_dashboard_12.get_dashboard_data',

frappe.pages['template_dashboard_18'].on_page_load = function(wrapper) {
    new TemplateDashboard18(wrapper);
};

class TemplateDashboard18 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-18');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_18' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 18';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_18.template_dashboard_18.get_dashboard_data',

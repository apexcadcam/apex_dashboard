frappe.pages['crm_dashboard'].on_page_load = function (wrapper) {
    ...
    // Load CSS
    frappe.require('/assets/apex_dashboard/page/crm_dashboard/crm_dashboard.css');
...
<div class="dashboard-template">
    <div class="dashboard-header">
        <div class="header-content">
            ...
            <p class="subtitle">Track your crm</p>
        </div>
        <div class="header-actions">
            <div class="total-card">
                <span class="label">Total CRM</span>
    ...
    // Initialize - use local class to avoid conflicts
    new CRMDashboard(wrapper, page);
}
...
class CRMDashboard {
    ...
    fetch_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.crm_dashboard.crm_dashboard.get_dashboard_data',
            args: args,
            callback: (r) => {

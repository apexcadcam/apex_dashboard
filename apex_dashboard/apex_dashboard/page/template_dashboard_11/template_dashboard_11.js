frappe.pages['template_dashboard_11'].on_page_load = function(wrapper) {
    new TemplateDashboard11(wrapper);
};

class TemplateDashboard11 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-11');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_11' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 11';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_11.template_dashboard_11.get_dashboard_data',

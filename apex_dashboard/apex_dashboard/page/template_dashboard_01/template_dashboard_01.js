frappe.pages['template_dashboard_01'].on_page_load = function(wrapper) {
    new TemplateDashboard01(wrapper);
};

class TemplateDashboard01 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-01');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_01' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 01';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_01.template_dashboard_01.get_dashboard_data',

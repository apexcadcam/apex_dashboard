frappe.pages['template_dashboard_08'].on_page_load = function(wrapper) {
    new TemplateDashboard08(wrapper);
};

class TemplateDashboard08 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-08');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_08' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 08';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_08.template_dashboard_08.get_dashboard_data',

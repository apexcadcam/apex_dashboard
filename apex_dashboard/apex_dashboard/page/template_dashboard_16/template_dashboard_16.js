frappe.pages['template_dashboard_16'].on_page_load = function(wrapper) {
    new TemplateDashboard16(wrapper);
};

class TemplateDashboard16 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-16');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_16' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 16';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_16.template_dashboard_16.get_dashboard_data',

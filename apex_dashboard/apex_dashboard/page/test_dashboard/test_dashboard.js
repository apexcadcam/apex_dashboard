frappe.pages['test_dashboard'].on_page_load = function (wrapper) {
    ...
    // Load CSS
    frappe.require('/assets/apex_dashboard/page/test_dashboard/test_dashboard.css');

    const TEMPLATE = `
<div class="dashboard-template">
    <div class="dashboard-header">
        <div class="header-content">
            <h1>Test Dashboard Overview</h1>
    ...
    // Initialize
    new TestDashboard(wrapper, page);
}
...
class TestDashboard {
    ...
    fetch_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.test_dashboard.test_dashboard.get_dashboard_data',
            args: args,
            callback: (r) => {

frappe.pages['template_dashboard_05'].on_page_load = function(wrapper) {
    new TemplateDashboard05(wrapper);
};

class TemplateDashboard05 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-05');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_05' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 05';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_05.template_dashboard_05.get_dashboard_data',

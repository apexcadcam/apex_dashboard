frappe.pages['template_dashboard_03'].on_page_load = function(wrapper) {
    new TemplateDashboard03(wrapper);
};

class TemplateDashboard03 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-03');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_03' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 03';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_03.template_dashboard_03.get_dashboard_data',

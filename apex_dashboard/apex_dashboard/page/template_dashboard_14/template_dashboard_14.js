frappe.pages['template_dashboard_14'].on_page_load = function(wrapper) {
    new TemplateDashboard14(wrapper);
};

class TemplateDashboard14 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-14');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_14' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 14';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_14.template_dashboard_14.get_dashboard_data',

frappe.pages['sales_dashboard'].on_page_load = function (wrapper) {
    ...
    // Load CSS
    frappe.require('/assets/apex_dashboard/page/sales_dashboard/sales_dashboard.css');
...
<div class="dashboard-template">
    <div class="dashboard-header">
        <div class="header-content">
            ...
            <p class="subtitle">Track your sales</p>
        </div>
    ...
    // Initialize
    new SalesDashboard(wrapper, page);
}
...
class SalesDashboard {
    ...
    fetch_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.sales_dashboard.sales_dashboard.get_dashboard_data',
            args: args,
            callback: (r) => {

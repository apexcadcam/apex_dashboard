frappe.pages['template_dashboard_07'].on_page_load = function(wrapper) {
    new TemplateDashboard07(wrapper);
};

class TemplateDashboard07 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-07');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_07' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 07';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_07.template_dashboard_07.get_dashboard_data',

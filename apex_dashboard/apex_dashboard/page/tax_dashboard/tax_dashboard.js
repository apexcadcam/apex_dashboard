frappe.pages['tax_dashboard'].on_page_load = function (wrapper) {
    ...
    // Load CSS
    frappe.require('/assets/apex_dashboard/page/tax_dashboard/tax_dashboard.css');

    const TEMPLATE = `
<div class="dashboard-template">
    <div class="dashboard-header">
        <div class="header-content">
            <h1>Tax Dashboard Overview</h1>
            <p class="subtitle">Track your tax/vat</p>
        </div>
        <div class="header-actions">
            <div class="total-card">
                <span class="label">Total TAX/VAT</span>
...
class TaxDashboard {
    ...
    fetch_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.tax_dashboard.tax_dashboard.get_dashboard_data',
            args: args,
            callback: (r) => {

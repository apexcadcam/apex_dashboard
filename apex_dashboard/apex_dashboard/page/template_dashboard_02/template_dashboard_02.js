frappe.pages['template_dashboard_02'].on_page_load = function(wrapper) {
    new TemplateDashboard02(wrapper);
};

class TemplateDashboard02 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-02');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_02' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 02';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_02.template_dashboard_02.get_dashboard_data',

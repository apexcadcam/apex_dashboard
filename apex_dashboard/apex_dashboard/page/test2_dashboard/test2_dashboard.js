frappe.pages['test2_dashboard'].on_page_load = function(wrapper) {
    new test2dashboard(wrapper);
};

class test2dashboard {
    constructor(wrapper) {
        ...
        this.page.main.addClass('test2-dashboard');
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.test2_dashboard.test2_dashboard.get_dashboard_data',

frappe.pages['template_dashboard_13'].on_page_load = function(wrapper) {
    new TemplateDashboard13(wrapper);
};

class TemplateDashboard13 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-13');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_13' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 13';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_13.template_dashboard_13.get_dashboard_data',

frappe.pages['template_dashboard_10'].on_page_load = function(wrapper) {
    new TemplateDashboard10(wrapper);
};

class TemplateDashboard10 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-10');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_10' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 10';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_10.template_dashboard_10.get_dashboard_data',

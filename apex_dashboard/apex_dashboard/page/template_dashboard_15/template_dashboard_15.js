frappe.pages['template_dashboard_15'].on_page_load = function(wrapper) {
    new TemplateDashboard15(wrapper);
};

class TemplateDashboard15 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-15');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_15' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 15';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_15.template_dashboard_15.get_dashboard_data',

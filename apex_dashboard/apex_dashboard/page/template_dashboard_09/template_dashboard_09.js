frappe.pages['template_dashboard_09'].on_page_load = function(wrapper) {
    new TemplateDashboard09(wrapper);
};

class TemplateDashboard09 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-09');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_09' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 09';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_09.template_dashboard_09.get_dashboard_data',

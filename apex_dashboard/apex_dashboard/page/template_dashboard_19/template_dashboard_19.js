frappe.pages['template_dashboard_19'].on_page_load = function(wrapper) {
    new TemplateDashboard19(wrapper);
};

class TemplateDashboard19 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-19');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_19' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 19';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_19.template_dashboard_19.get_dashboard_data',

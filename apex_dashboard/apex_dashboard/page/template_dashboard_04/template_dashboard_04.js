frappe.pages['template_dashboard_04'].on_page_load = function(wrapper) {
    new TemplateDashboard04(wrapper);
};

class TemplateDashboard04 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-04');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_04' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 04';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_04.template_dashboard_04.get_dashboard_data',

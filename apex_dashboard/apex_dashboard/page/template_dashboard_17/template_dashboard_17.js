frappe.pages['template_dashboard_17'].on_page_load = function(wrapper) {
    new TemplateDashboard17(wrapper);
};

class TemplateDashboard17 {
    constructor(wrapper) {
        ...
        this.page.main.addClass('template-dashboard-17');
    ...
    load_dashboard_title() {
        ...
        frappe.call({
            ...
            args: {
                ...
                filters: { route: 'template_dashboard_17' },
                fieldname: ['title', 'icon']
            },
            callback: (r) => {
                if (r.message) {
                    let title = r.message.title || 'Template Dashboard 17';
    ...
    load_data() {
        ...
        frappe.call({
            method: 'apex_dashboard.apex_dashboard.page.template_dashboard_17.template_dashboard_17.get_dashboard_data',
